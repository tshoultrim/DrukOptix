...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — DrukOptix" }, { name: "description", content: "Sign in to DrukOptix." }] }),
  component: LoginPage,
});
    ...
    <section className="py-16 md:py-24" style={{ background: "var(--gradient-hero)" }}>
      <Container className="max-w-md">
        <div className="rounded-2xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Welcome back to DrukOptix.</p>
