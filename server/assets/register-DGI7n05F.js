...
function RegisterPage() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: {
    ...
    /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-border bg-card p-8 shadow-[var(--shadow-card)]", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Get started with DrukOptix." }),
      /* @__PURE__ */ jsxs("button", { onClick: google, className: "mt-6 flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium hover:bg-secondary transition-smooth", children: [
        /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 48 48", width: "18", height: "18", "aria-hidden": true, children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-4", noValidate: true, children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-1.5 block text-sm font-medium", children: "Full name" }),
          /* @__PURE__ */ jsx("input", { ...form.register("fullName"), className: "auth-input", maxLength: 100 }),
          form.formState.errors.fullName && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-destructive", children: form.formState.errors.fullName.message })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("button", { disabled: loading, className: "w-full rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary-hover transition-smooth disabled:opacity-60", children: loading ? "Creating…" : "Create account" })
      ] }),
